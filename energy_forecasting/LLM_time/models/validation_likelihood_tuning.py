...
def get_autotuned_predictions_data(train, test, task_name, hypers, num_samples, get_predictions_fn, verbose=False, parallel=True, n_train=None, n_val=None):
    """
    ...
    out = get_predictions_fn(train, test, task_name, **best_hyper, num_samples=num_samples, n_train=n_train)
